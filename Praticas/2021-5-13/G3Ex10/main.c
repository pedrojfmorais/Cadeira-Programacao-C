...
{
    int op;
	Cliente novo = {"Ricardo Lopes", "Coimbra", 110, 5000};
	...
	do{
		...
		switch(op){
			...
			case 3:   printf("Ficheiro 1:\n"); mostra_ficheiro_invertido("clientes1_ex10.dat") ;
					  ...
					  break;
			case 4:   transfere("clientes1_ex10.dat", "Elsa Ourem", "Dinis Pais", 1000000); //deveria receber o 1 ou 0 para saber se a transferência correu bem
					  break;
